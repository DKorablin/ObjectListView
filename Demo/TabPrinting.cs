...
namespace ObjectListViewDemo
{
	public partial class TabPrinting : OlvDemoTab
	{
		...
		protected override void InitializeTab()
		{
			...
			listViewPrinter1.PrintPage += (sender, e)
				=> this.Coordinator.ToolStripStatus1 = String.Format("Printing page #{0}...", this.listViewPrinter1.PageNumber);

			listViewPrinter1.EndPrint += (sender, e)
				=> this.Coordinator.ToolStripStatus1 = "Printing done";
		...
		public void UpdatePrintPreview()
		{
			...
			this.listViewPrinter1.FirstPage = (Int32)this.numericFrom.Value;
			this.listViewPrinter1.LastPage = (Int32)this.numericTo.Value;
		...
		private void ApplyOverTheTopFormatting()
		{
			...
			this.listViewPrinter1.HeaderFormat.BackgroundBrush = new TextureBrush(Resource.star16, WrapMode.Tile);
