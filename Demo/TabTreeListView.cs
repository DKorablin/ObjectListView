...
namespace ObjectListViewDemo
{
	public partial class TabTreeListView : OlvDemoTab
	{
		...
		private void SetupDragAndDrop()
		{
			...
			treeListView.ModelCanDrop += (sender, e) =>
			{
			...
			treeListView.ModelDropped += (sender, e) =>
			{
				...
				this.Coordinator.ShowMessage(msg);
			};
		}
		...
		private void SetupTree()
		{
			...
			this.treeListView.CanExpandGetter = (x) => ((MyFileSystemInfo)x).IsDirectory;
		...
		private void SetupColumns()
		{
			...
			this.olvColumnName.ImageGetter = (x) => helper.GetImageIndex(((MyFileSystemInfo)x).FullName);
			...
			this.olvColumnFileType.AspectGetter = (x) => ShellUtilities.GetFileType(((MyFileSystemInfo)x).FullName);
			...
			this.olvColumnAttributes.AspectGetter = (x) => ((MyFileSystemInfo)x).Attributes;
