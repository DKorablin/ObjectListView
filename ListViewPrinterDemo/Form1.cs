...
namespace ListViewPrinterDemo
{
	public partial class Form1 : Form
	{
		...
		{
			Int32 pages = (Int32)this.numericUpDown1.Value;
		...
		/// <summary>Give the report a minimal set of default formatting values.</summary>
		...
		/// <summary>Give the report a some outrageous formatting values.</summary>
		...
		/// <summary>Copy the formatting from the formatting that the user has setup on the custom format panel.</summary>
