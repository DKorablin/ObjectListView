...
{
	/// <summary>An IDragSource controls how drag out from the ObjectListView will behave</summary>
	public interface IDragSource
	{
		...
		/// </summary>
		/// <remarks>The returned Object is later passed to the GetAllowedEffect() and EndDrag() methods.</remarks>
		...
		/// <summary>What operations are possible for this drag? This controls the icon shown during the drag</summary>
		...
		/// <summary>The drag operation is complete. Do whatever is necessary to complete the action.</summary>
		/// <param name="dragObject">The data Object returned by StartDrag()</param>
		/// <param name="effect">The value returned from GetAllowedEffects()</param>
		void EndDrag(Object dragObject, DragDropEffects effect);
	}

	/// <summary>A do-nothing implementation of IDragSource that can be safely subclassed.</summary>
	...
	public class SimpleDragSource : IDragSource
	{
		...
		/// <summary>Construct a SimpleDragSource</summary>
		public SimpleDragSource()
		{
		}

		/// <summary>Construct a SimpleDragSource that refreshes the dragged rows when the drag is complete</summary>
		/// <param name="refreshAfterDrop"></param>
		public SimpleDragSource(Boolean refreshAfterDrop)
		...
		/// <summary>Gets or sets whether the dragged rows should be refreshed when the drag operation is complete.</summary>
		public Boolean RefreshAfterDrop { get; set; }

		#endregion

		#region IDragSource Members

		/// <summary>Create a DataObject when the user does a left mouse drag operation.</summary>
		/// <remarks>See IDragSource for further information.</remarks>
		/// <param name="olv"></param>
		/// <param name="button"></param>
		/// <param name="item"></param>
		/// <returns></returns>
		public virtual Object StartDrag(ObjectListView olv, MouseButtons button, OLVListItem item)
			=> button != MouseButtons.Left// We only drag on left mouse
				? null
				: this.CreateDataObject(olv);

		/// <summary>Which operations are allowed in the operation? By default, all operations are supported.</summary>
		/// <param name="dragObject"></param>
		/// <returns>All operations are supported</returns>
		public virtual DragDropEffects GetAllowedEffects(Object dragObject)
			=> DragDropEffects.All | DragDropEffects.Link; // why didn't MS include 'Link' in 'All'??

		/// <summary>The drag operation is finished. Refreshes the dragged rows if so configured.</summary>
		/// <param name="dragObject"></param>
		/// <param name="effect"></param>
		public virtual void EndDrag(Object dragObject, DragDropEffects effect)
		{
		...
		/// <summary>Create a data Object that will be used to as the data Object for the drag operation.</summary>
		/// <remarks>Subclasses can override this method add new formats to the data Object.</remarks>
