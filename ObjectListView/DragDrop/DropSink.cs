...
{
	/// <summary>Objects that implement this interface can acts as the receiver for drop operation for an ObjectListView.</summary>
	public interface IDropSink
	{
		/// <summary>Gets or sets the ObjectListView that is the drop sink</summary>
		ObjectListView ListView { get; set; }

		/// <summary>Draw any feedback that is appropriate to the current drop state.</summary>
		/// <remarks>
		...
		/// <summary>The user has released the drop over this control</summary>
		/// <remarks>
		/// Implementors should set args.Effect to the appropriate DragDropEffects.
		/// This value is returned to the originator of the drag.
		/// </remarks>
		/// <param name="args"></param>
		void Drop(DragEventArgs args);

		/// <summary>A drag has entered this control.</summary>
		/// <remarks>Implementors should set args.Effect to the appropriate DragDropEffects.</remarks>
		/// <param name="args"></param>
		void Enter(DragEventArgs args);

		/// <summary>Change the cursor to reflect the current drag operation.</summary>
		/// <param name="args"></param>
		void GiveFeedback(GiveFeedbackEventArgs args);

		/// <summary>The drag has left the bounds of this control</summary>
		void Leave();

		/// <summary>The drag is moving over this control.</summary>
		...
		/// <summary>Should the drag be allowed to continue?</summary>
		/// <param name="args"></param>
		void QueryContinue(QueryContinueDragEventArgs args);
	}

	/// <summary>This is a do-nothing implementation of IDropSink that is a useful base class for more sophisticated implementations.</summary>
	public class AbstractDropSink : IDropSink
	{
		...
		/// <summary>This is called when the mouse leaves the drop region and after the drop has completed.</summary>
	...
	/// <summary>The enum indicates which target has been found for a drop operation</summary>
	[Flags]
	public enum DropTargetLocation
	{
		/// <summary>No applicable target has been found</summary>
		None = 0,

		/// <summary>The list itself is the target of the drop</summary>
		Background = 0x01,

		/// <summary>An item is the target</summary>
		Item = 0x02,
		...
		/// <summary>Above an item is the target</summary>
		AboveItem = 0x08,

		/// <summary>Below an item is the target</summary>
		BelowItem = 0x10,

		/// <summary>A subitem is the target of the drop</summary>
		SubItem = 0x20,

		/// <summary>On the right of an item is the target</summary>
		RightOfItem = 0x40,

		/// <summary>On the left of an item is the target</summary>
		LeftOfItem = 0x80
	}

	/// <summary>This class represents a simple implementation of a drop sink.</summary>
	/// <remarks>Actually, it should be called CleverDropSink -- it's far from simple and can do quite a lot in its own right.</remarks>
	public class SimpleDropSink : AbstractDropSink
	{
		#region Life and death

		/// <summary>Make a new drop sink</summary>
		...
		/// <summary>Get or set the locations where a drop is allowed to occur (OR-ed together)</summary>
		public DropTargetLocation AcceptableLocations { get; set; }

		/// <summary>Gets or sets whether this sink allows model objects to be dragged from other lists.</summary>
		/// <remarks>Defaults to true.</remarks>
		public Boolean AcceptExternal { get; set; } = true;

		/// <summary>Gets or sets whether the ObjectListView should scroll when the user drags something near to the top or bottom rows.</summary>
		/// <remarks>AutoScroll does not scroll horizontally. Defaults to true.</remarks>
		public Boolean AutoScroll { get; set; } = true;

		/// <summary>Gets the billboard overlay that will be used to display feedback messages during a drag operation. </summary>
		/// <remarks>Set this to null to stop the feedback.</remarks>
		public BillboardOverlay Billboard { get; set; }

		/// <summary>Get or set whether a drop can occur between items of the list</summary>
		public Boolean CanDropBetween
		{
		...
		/// <summary>Get or set whether a drop can occur on the listview itself</summary>
		public Boolean CanDropOnBackground
		{
		...
		/// <summary>Get or set whether a drop can occur on items in the list</summary>
		public Boolean CanDropOnItem
		{
		...
		/// <summary>Get or set whether a drop can occur on a subitem in the list</summary>
		public Boolean CanDropOnSubItem
		{
		...
		/// <summary>Gets or sets whether the drop sink should draw feedback onto the given list during the drag operation.</summary>
		/// <remarks>If this is false, you will have to give the user feedback in some other fashion, like cursor changes. Defaults to true.</remarks>
		public Boolean EnableFeedback { get; set; } = true;

		/// <summary>Get or set the index of the item that is the target of the drop</summary>
		public Int32 DropTargetIndex
		{
			get { return _dropTargetIndex; }
			set
			{
				if(this._dropTargetIndex != value)
				{
					this._dropTargetIndex = value;
					this.ListView.Invalidate();
				}
			}
		}
		private Int32 _dropTargetIndex = -1;

		/// <summary>Get the item that is the target of the drop</summary>
		public OLVListItem DropTargetItem
		{
			get => this.ListView.GetItem(this.DropTargetIndex);
		}

		/// <summary>Get or set the location of the target of the drop</summary>
		public DropTargetLocation DropTargetLocation
		{
			get { return _dropTargetLocation; }
			set
			{
				if(this._dropTargetLocation != value)
				{
					this._dropTargetLocation = value;
					this.ListView.Invalidate();
				}
			}
		}
		...
		/// <summary>Get or set the index of the subitem that is the target of the drop</summary>
		public Int32 DropTargetSubItemIndex
		{
			get { return _dropTargetSubItemIndex; }
			set
			{
				if(this._dropTargetSubItemIndex != value)
				{
					this._dropTargetSubItemIndex = value;
					this.ListView.Invalidate();
				}
			}
		}
		private Int32 _dropTargetSubItemIndex = -1;

		/// <summary>Get or set the color that will be used to provide drop feedback</summary>
		public Color FeedbackColor { get; set; }

		/// <summary>Get whether the alt key was down during this drop event</summary>
		public Boolean IsAltDown
		{
			get => (this.KeyState & 32) == 32;
		}

		/// <summary>Get whether any modifier key was down during this drop event</summary>
		public Boolean IsAnyModifierDown
		{
			get => (this.KeyState & (4 + 8 + 32)) != 0;
		}

		/// <summary>Get whether the control key was down during this drop event</summary>
		public Boolean IsControlDown
		{
			get => (this.KeyState & 8) == 8;
		}

		/// <summary>Get whether the left mouse button was down during this drop event</summary>
		public Boolean IsLeftMouseButtonDown
		{
			get => (this.KeyState & 1) == 1;
		}

		/// <summary>Get whether the right mouse button was down during this drop event</summary>
		public Boolean IsMiddleMouseButtonDown
		{
			get => (this.KeyState & 16) == 16;
		}

		/// <summary>Get whether the right mouse button was down during this drop event</summary>
		public Boolean IsRightMouseButtonDown
		{
			get => (this.KeyState & 2) == 2;
		}

		/// <summary>Get whether the shift key was down during this drop event</summary>
		public Boolean IsShiftDown
		{
			get => (this.KeyState & 4) == 4;
		}

		/// <summary>Get or set the state of the keys during this drop event</summary>
		public Int32 KeyState { get; set; }

		/// <summary>
		/// Gets or sets whether the drop sink will automatically use cursors
		/// based on the drop effect. By default, this is true.
		/// If this is set to false, you must set the Cursor yourself.
		/// </summary>
		public Boolean UseDefaultCursors { get; set; } = true;

		#endregion

		#region Events

		/// <summary>Triggered when the sink needs to know if a drop can occur.</summary>
		/// <remarks>
		/// Handlers should set Effect to indicate what is possible.
		/// Handlers can change any of the DropTarget* settings to change the target of the drop.
		/// </remarks>
		public event EventHandler<OlvDropEventArgs> CanDrop;

		/// <summary>Triggered when the drop is made.</summary>
		public event EventHandler<OlvDropEventArgs> Dropped;

		/// <summary>Triggered when the sink needs to know if a drop can occur AND the source is an ObjectListView</summary>
		/// <remarks>
		/// Handlers should set Effect to indicate what is possible.
		/// Handlers can change any of the DropTarget* settings to change the target of the drop.
		/// </remarks>
		...
		/// <summary>Triggered when the drop is made. AND the source is an ObjectListView</summary>
		...
		/// <summary>Cleanup the drop sink when the mouse has left the control or the drag has finished.</summary>
		...
		/// <summary>Draw any feedback that is appropriate to the current drop state.</summary>
		/// <remarks>
		/// Any drawing is done over the top of the ListView.
		/// This operation should disturb the Graphic as little as possible.
		/// Specifically, do not erase the area into which you draw.
		/// </remarks>
		/// <param name="g">A Graphic for drawing</param>
		/// <param name="bounds">The contents bounds of the ListView (not including any header)</param>
		...
		/// <summary>Trigger the Dropped events</summary>
		/// <param name="args"></param>
		...
		/// <summary>Trigger ModelDropped</summary>
		/// <param name="args"></param>
		...
		/// <summary>Handle the timer tick event, which is sent when the listview should scroll</summary>
		protected virtual void HandleTimerTick()
		{
			...
			const Int32 GRACE_PERIMETER = 30;
		...
		/// <summary>When the mouse is at the given point, what should the target of the drop be?</summary>
		...
		protected virtual void CalculateDropTarget(OlvDropEventArgs args, Point pt)
		{
			...
			if(this.CanDropBetween && this.ListView.GetItemCount() > 0)
			{
				...
				case View.SmallIcon:
					...
					if(info.Item != null)
					{
						Int32 delta = this.CanDropOnItem ? SMALL_VALUE : info.Item.Bounds.Width / 2;
					...
					} else
					{
						...
						Int32 probeWidth = SMALL_VALUE * 2;
				...
				case View.List:
					...
					if(info.Item != null)
					{
						Int32 delta = this.CanDropOnItem ? SMALL_VALUE : this.ListView.RowHeightEffective / 2;
		...
		/// <summary>What sort of action is possible when the mouse is at the given point?</summary>
		/// <remarks></remarks>
		/// <param name="args"></param>
		/// <param name="pt"></param>
		/// <returns></returns>
		...
		/// <summary>Based solely on the state of the modifier keys, what drop operation shouldbe used?</summary>
		...
		/// <summary>Should the listview be made to scroll when the mouse is at the given point?</summary>
		/// <param name="pt"></param>
		protected virtual void CheckScrolling(Point pt)
		{
			...
			Int32 rowHeight = this.ListView.RowHeightEffective;
			Int32 close = rowHeight;
			...
			if(pt.Y <= (r.Top + close))
			{
				...
				this._timer.Interval = ((pt.Y <= (r.Top + close / 2)) ? 100 : 350);
				this._timer.Start();
			...
			} else
			{
				...
				{
					this._timer.Interval = ((pt.Y >= (r.Bottom - close / 2)) ? 100 : 350);
					this._timer.Start();
					this.scrollAmount = rowHeight;
				} else
				{
		...
		/// <summary>Update the state of our sink to reflect the information that may have been written into the drop event args.</summary>
		/// <param name="args"></param>
		...
		/// <summary>Draw the feedback that shows that the background is the target</summary>
		/// <param name="g"></param>
		/// <param name="bounds"></param>
		protected virtual void DrawFeedbackBackgroundTarget(Graphics g, Rectangle bounds)
		{
			Single penWidth = 12.0f;
			Rectangle r = bounds;
			r.Inflate((Int32)(-penWidth) / 2, (Int32)(-penWidth) / 2);
			using(Pen p = new Pen(Color.FromArgb(128, this.FeedbackColor), penWidth))
			using(GraphicsPath path = this.GetRoundedRect(r, 30.0f))
				g.DrawPath(p, path);
		}

		/// <summary>Draw the feedback that shows that an item (or a subitem) is the target</summary>
		/// <param name="g"></param>
		/// <param name="bounds"></param>
		/// <remarks>DropTargetItem and DropTargetSubItemIndex tells what is the target</remarks>
		protected virtual void DrawFeedbackItemTarget(Graphics g, Rectangle bounds)
		{
			...
			r.Inflate(1, 1);
			Single diameter = (Single)r.Height / 3;
		...
		/// <summary>Draw the feedback that shows the drop will occur before target</summary>
		/// <param name="g"></param>
		/// <param name="bounds"></param>
		...
		/// <summary>Draw the feedback that shows the drop will occur after target</summary>
		/// <param name="g"></param>
		/// <param name="bounds"></param>
		...
		/// <summary>Draw the feedback that shows the drop will occur to the left of target</summary>
		/// <param name="g"></param>
		/// <param name="bounds"></param>
		...
		/// <summary>Draw the feedback that shows the drop will occur to the right of target</summary>
		/// <param name="g"></param>
		/// <param name="bounds"></param>
		...
		/// <summary>Return a GraphicPath that is round corner rectangle.</summary>
		/// <param name="rect"></param>
		/// <param name="diameter"></param>
		/// <returns></returns>
		protected GraphicsPath GetRoundedRect(Rectangle rect, Single diameter)
		{
		...
		/// <summary>Calculate the target rectangle when the given item (and possible subitem) is the target of the drop.</summary>
		/// <param name="item"></param>
		/// <param name="subItem"></param>
		/// <returns></returns>
		protected virtual Rectangle CalculateDropTargetRectangle(OLVListItem item, Int32 subItem)
		{
			if(subItem > 0)
			...
			{
				Int32 indentWidth = this.ListView.SmallImageSize.Width * item.IndentCount;
				r.X += indentWidth;
				r.Width -= indentWidth;
			}
		...
		/// <summary>Draw a "between items" line at the given co-ordinates</summary>
		/// <param name="g"></param>
		/// <param name="x1"></param>
		/// <param name="y1"></param>
		/// <param name="x2"></param>
		/// <param name="y2"></param>
		protected virtual void DrawBetweenLine(Graphics g, Int32 x1, Int32 y1, Int32 x2, Int32 y2)
		{
		...
		private const Int32 ARROW_SIZE = 6;
		...
		private static Point[] RightPointingArrow(Int32 x, Int32 y)
		{
			return new Point[] {
		...
		private static Point[] LeftPointingArrow(Int32 x, Int32 y)
		{
			return new Point[] {
				new Point(x, y - ARROW_SIZE),
				new Point(x, y + ARROW_SIZE),
		...
		private static Point[] DownPointingArrow(Int32 x, Int32 y)
			=> new Point[] {
				new Point(x - ARROW_SIZE, y),
				new Point(x + ARROW_SIZE, y),
				new Point(x, y + ARROW_SIZE)
		...
		private static Point[] UpPointingArrow(Int32 x, Int32 y)
			=> new Point[] {
				new Point(x - ARROW_SIZE, y),
				new Point(x + ARROW_SIZE, y),
				new Point(x, y - ARROW_SIZE)
		...
		private Int32 scrollAmount;
		private Boolean originalFullRowSelect;
		private ModelDropEventArgs dropEventArgs;
	}

	/// <summary>This drop sink allows items within the same list to be rearranged, as well as allowing items to be dropped from other lists.</summary>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <para>This class does not work with grouping.</para>
	/// <para>
	...
	/// </para>
	/// <para>Users of this class should listen for the CanDrop event to decide if models from another OLV can be moved to OLV under this sink.</para>
	/// </remarks>
	public class RearrangingDropSink : SimpleDropSink
	{
		/// <summary>Create a RearrangingDropSink</summary>
		...
		public RearrangingDropSink(Boolean acceptDropsFromOtherLists)
			: this()
			=> this.AcceptExternal = acceptDropsFromOtherLists;

		/// <summary>Trigger OnModelCanDrop</summary>
		/// <param name="args"></param>
		...
		/// <summary>Trigger OnModelDropped</summary>
		/// <param name="args"></param>
		...
		/// <summary>Do the work of processing the dropped items</summary>
		/// <param name="args"></param>
	...
	/// <summary>When a drop sink needs to know if something can be dropped, or to notify that a drop has occurred, it uses an instance of this class.</summary>
	public class OlvDropEventArgs : EventArgs
	{
		/// <summary>Create a OlvDropEventArgs</summary>
		...
		/// <summary>Get the original drag-drop event args</summary>
		public DragEventArgs DragEventArgs { get; internal set; }

		/// <summary>Get the data Object that is being dragged</summary>
		public Object DataObject { get; internal set; }

		/// <summary>Get the drop sink that originated this event</summary>
		public SimpleDropSink DropSink { get; internal set; }

		/// <summary>Get or set the index of the item that is the target of the drop</summary>
		public Int32 DropTargetIndex { get; set; } = -1;

		/// <summary>Get or set the location of the target of the drop</summary>
		public DropTargetLocation DropTargetLocation { get; set; }

		/// <summary>Get or set the index of the subitem that is the target of the drop</summary>
		public Int32 DropTargetSubItemIndex { get; set; } = -1;

		/// <summary>Get the item that is the target of the drop</summary>
		public OLVListItem DropTargetItem
		{
			get => this.ListView.GetItem(this.DropTargetIndex);
			set => this.DropTargetIndex = value == null
					? -1
					: value.Index;
		}

		/// <summary>Get or set the drag effect that should be used for this operation</summary>
		public DragDropEffects Effect { get; set; }

		/// <summary>Get or set if this event was handled. No further processing will be done for a handled event.</summary>
		public Boolean Handled { get; set; }

		/// <summary>Get or set the feedback message for this operation</summary>
		/// <remarks>If this is not null, it will be displayed as a feedback message during the drag.</remarks>
		public String InfoMessage { get; set; }

		/// <summary>Get the ObjectListView that is being dropped on</summary>
		public ObjectListView ListView { get; internal set; }

		/// <summary>Get the location of the mouse (in target ListView co-ords)</summary>
		public Point MouseLocation { get; internal set; }

		/// <summary>Get the drop action indicated solely by the state of the modifier keys</summary>
	...
	/// <summary>These events are triggered when the drag source is an ObjectListView.</summary>
	public class ModelDropEventArgs : OlvDropEventArgs
	{
		/// <summary>Create a ModelDropEventArgs</summary>
		public ModelDropEventArgs()
		{
		}

		/// <summary>Gets the model objects that are being dragged.</summary>
		public IList SourceModels
		{
			get => this._dragModels;
			internal set
			{
				this._dragModels = value;
				if(this.SourceListView is TreeListView tlv)
				{
					foreach(Object model in this.SourceModels)
					{
						Object parent = tlv.GetParent(model);
						if(!this._toBeRefreshed.Contains(parent))
							this._toBeRefreshed.Add(parent);
					}
				}
			}
		}
		...
		/// <summary>Gets the ObjectListView that is the source of the dragged objects.</summary>
		public ObjectListView SourceListView { get; internal set; }

		/// <summary>Get the model Object that is being dropped upon.</summary>
		/// <remarks>This is only value for TargetLocation == Item</remarks>
		public Object TargetModel { get; internal set; }

		/// <summary>Refresh all the objects involved in the operation</summary>
		public void RefreshObjects()
		{
			this._toBeRefreshed.AddRange(this.SourceModels);
			if(this.SourceListView is TreeListView tlv)
				tlv.RebuildAll(true);
			else
				this.SourceListView.RefreshObjects(this._toBeRefreshed);

			if(this.ListView is TreeListView tlv2)
