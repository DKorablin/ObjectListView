...
namespace BrightIdeasSoftware
{
	...
	public class OLVDataObject : DataObject
	{
		...
		/// <summary>Gets or sets whether hidden columns will also be included in the text and HTML representation.</summary>
		/// <remarks>If this is false, only visible columns will be included.</remarks>
		public Boolean IncludeHiddenColumns { get; }

		/// <summary>Gets or sets whether column headers will also be included in the text and HTML representation.</summary>
		public Boolean IncludeColumnHeaders { get; }
		...
		/// <summary>Create an exporter for the data contained in this Object</summary>
		/// <returns></returns>
		...
		private String ConvertToHtmlFragment(String fragment)
		{
			...
			Int32 endFragment = startFragment + fragment.Length;
