...
namespace BrightIdeasSoftware
{
	...
	public class FastDataListView : FastObjectListView
	{
		...
		/// <summary>Get or set the VirtualListDataSource that will be displayed in this list view.</summary>
		...
		{
			get => _adapter ?? (_adapter = this.CreateDataSourceAdapter());
			set => _adapter = value;
		}
		...
		/// <summary>Create the DataSourceAdapter that this control will use.</summary>
