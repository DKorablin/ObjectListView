...
namespace BrightIdeasSoftware
{
	...
	/// <summary>This class calculates clusters from the groups that the column uses.</summary>
	/// <remarks>
	/// <para>This is the default strategy for all non-date, filterable columns.</para>
	/// <para>
	...
	/// by listening for grouping events, this class will not mimic that behavior.
	/// </para>
	/// </remarks>
