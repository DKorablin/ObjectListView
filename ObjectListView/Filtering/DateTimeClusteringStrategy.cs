...
namespace BrightIdeasSoftware
{
	...
	/// <summary>This enum is used to indicate various portions of a datetime</summary>
	[Flags]
	...
	/// <summary>This class implements a strategy where the model objects are clustered according to some portion of the datetime value in the configured column.</summary>
	...
	/// </remarks>
	/// <example>someColumn.ClusteringStrategy = new DateTimeClusteringStrategy(DateTimePortion.Month, "MMMM");</example>
	public class DateTimeClusteringStrategy : ClusteringStrategy
	{
		#region Life and death

		/// <summary>Create a strategy that clusters by month/year</summary>
		public DateTimeClusteringStrategy()
			: this(DateTimePortion.Year | DateTimePortion.Month, "MMMM yyyy")
		{
		}

		/// <summary>Create a strategy that clusters around the given parts</summary>
		...
		/// <summary>Gets or sets the format String that will be used to create a user-presentable version of the cluster key.</summary>
		...
		/// <summary>Gets or sets the parts of the DateTime that will be extracted when determining the clustering key for an Object.</summary>
		...
		public override Object GetClusterKey(Object model)
		{
			...
			Int32 year = ((this.Portions & DateTimePortion.Year) == DateTimePortion.Year) ? dateTime.Value.Year : 1;
			Int32 month = ((this.Portions & DateTimePortion.Month) == DateTimePortion.Month) ? dateTime.Value.Month : 1;
			Int32 day = ((this.Portions & DateTimePortion.Day) == DateTimePortion.Day) ? dateTime.Value.Day : 1;
			Int32 hour = ((this.Portions & DateTimePortion.Hour) == DateTimePortion.Hour) ? dateTime.Value.Hour : 0;
			Int32 minute = ((this.Portions & DateTimePortion.Minute) == DateTimePortion.Minute) ? dateTime.Value.Minute : 0;
			Int32 second = ((this.Portions & DateTimePortion.Second) == DateTimePortion.Second) ? dateTime.Value.Second : 0;
		...
		/// <summary>Convert the given date into a user presentable String</summary>
