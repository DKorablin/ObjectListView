...
namespace BrightIdeasSoftware
{
	...
	public interface IClusteringStrategy
	{
		...
		/// <summary>Gets or sets the column upon which this strategy will operate</summary>
		...
		/// <remarks>If the returned value is an IEnumerable, the given model is considered to belong to multiple clusters</remarks>
