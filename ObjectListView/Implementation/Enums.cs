...
namespace BrightIdeasSoftware
{
	public partial class ObjectListView
	{
		...
		public enum CellEditActivateMode
		{
			...
			/// selects the row just like normal.
			/// </summary>
			/// <remarks>The user must press F2 to edit the primary column.</remarks>
			SingleClick = 1,

			/// <summary>Double clicking a subitem or the primary column will edit that cell.</summary>
			/// <remarks>F2 will edit the primary column.</remarks>
			DoubleClick = 2,

			/// <summary>
			/// Pressing F2 is the only way to edit the cells.
			/// Once the primary column is being edited, the other cells in the row can be edited by pressing Tab.
			/// </summary>
			F2Only = 3,
