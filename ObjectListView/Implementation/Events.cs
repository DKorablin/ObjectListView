...
namespace BrightIdeasSoftware
{
    ...
    public partial class ObjectListView
    {
        ...
        /// <remarks>
        /// You can make changes to the groups, which have been created, before those groups are created within the listview.
        /// </remarks>
        [Category("ObjectListView")]
    ...
    {
        /// <summary>Gets or set if this event completely handled. If it was, no further processing will be done for it.
        /// </summary>
        public Boolean Handled { get; set; }
        ...
        public override String ToString()
            => String.Format("NewHotCellHitLocation: {0}, HotCellHitLocationEx: {1}, NewHotColumnIndex: {2}, NewHotRowIndex: {3}, HotGroup: {4}", this.HotCellHitLocation, this.HotCellHitLocationEx, this.HotColumnIndex, this.HotRowIndex, this.HotGroup);
    }
