...
namespace BrightIdeasSoftware.Design
{
	...
	/// <summary>Designer for <see cref="ObjectListView"/> and its subclasses.</summary>
	/// <remarks>
	/// <para>This designer removes properties and events that are available on ListView but that are not useful on ObjectListView.</para>
	/// <para>
	...
	public class ObjectListViewDesigner : ControlDesigner
	{
		...
		public override void Initialize(IComponent component)
		{
			...
			this._listViewDesignGetHitTest = tListViewDesigner.GetMethod("GetHitTest", BindingFlags.Instance | BindingFlags.NonPublic);
			this._listViewDesignWndProc = tListViewDesigner.GetMethod("WndProc", BindingFlags.Instance | BindingFlags.NonPublic);

			Debug.Assert(this._listViewDesignGetHitTest != null, "Required method (GetHitTest) not found on ListViewDesigner");
			Debug.Assert(this._listViewDesignWndProc != null, "Required method (WndProc) not found on ListViewDesigner");
			...
			TypeDescriptor.CreateAssociation(component, this._listViewDesigner);
			...
			this._listViewDesigner.Initialize(component);
		...
		public override void InitializeNewComponent(IDictionary defaultValues)
		{
			...
			this._listViewDesigner.InitializeNewComponent(defaultValues);
		}
		...
		protected override void Dispose(Boolean disposing)
		{
			...
			if(disposing)
				this._listViewDesigner?.Dispose();
			// Normally we would now null out the designer, but this designer still has methods called AFTER it is disposed.

			base.Dispose(disposing);
		}

		/// <summary>Removes the duplicate DockingActionList added by this designer to the <see cref="DesignerActionService"/>.</summary>
		/// <remarks>
		...
		private void RemoveDuplicateDockingActionList()
		{
			...
			if(fi != null)
			{
				...
				{
					DesignerActionService service = (DesignerActionService)this.GetService(typeof(DesignerActionService));
		...
		/// <summary>Adjusts the set of properties the component exposes through a <see cref="System.ComponentModel.TypeDescriptor"/>.</summary>
		...
		protected override void PreFilterEvents(IDictionary events)
		{
			...
			this._designerFilter.PreFilterEvents(events);
		...
		protected override void PostFilterAttributes(IDictionary attributes)
		{
			...
			this._designerFilter.PostFilterAttributes(attributes);
		...
		protected override void PostFilterEvents(IDictionary events)
		{
			...
			this._designerFilter.PostFilterEvents(events);
		...
		public override DesignerActionListCollection ActionLists
		{
			get
			{
				...
				DesignerActionListCollection actionLists = this._listViewDesigner.ActionLists;
		...
		public override ICollection AssociatedComponents
		{
			get
			{
				...
				components.AddRange(this._listViewDesigner.AssociatedComponents);
				return components;
			}
		}
		...
		protected override Boolean GetHitTest(Point point)
			// The ListViewDesigner wants to allow column dividers to be resized
			=> (Boolean)this._listViewDesignGetHitTest.Invoke(_listViewDesigner, new Object[] { point });
		...
		private ControlDesigner _listViewDesigner;
		private IDesignerFilter _designerFilter;
		private MethodInfo _listViewDesignGetHitTest;
		private MethodInfo _listViewDesignWndProc;
		...
		private sealed class ListViewActionListAdapter : DesignerActionList
		{
			...
			public void InvokeColumnsDialog()
				=> this.EditValue(this._designer, base.Component, "Columns");
			...
			public ImageList LargeImageList
			{
				...
				set => this.SetValue(base.Component, "LargeImageList", value);
			}

			public ImageList SmallImageList
			{
				get => ((ListView)base.Component).SmallImageList;
				set => this.SetValue(base.Component, "SmallImageList", value);
			}
		...
		private sealed class CDDesignerCommandSet : DesignerCommandSet
		{
			...
			public override ICollection GetCommands(String name)
			{
				...
				if(this._componentDesigner != null)
				{
	...
	/// <summary>This class works in conjunction with the OLVColumns property to allow OLVColumns to be added to the ObjectListView.</summary>
	public class OLVColumnCollectionEditor : CollectionEditor
	{
		/// <summary>Create a OLVColumnCollectionEditor</summary>
		/// <param name="t"></param>
		...
		/// <summary>What type of Object does this editor create?</summary>
		/// <returns></returns>
		protected override Type CreateCollectionItemType()
			=> typeof(OLVColumn);

		/// <summary>Edit a given value</summary>
		...
		/// <summary>What text should be shown in the list for the given Object?</summary>
		/// <param name="value"></param>
		/// <returns></returns>
		protected override String GetDisplayText(Object value)
		{
			OLVColumn col = value as OLVColumn;
			return String.IsNullOrEmpty(col?.AspectName)
				? base.GetDisplayText(value)
				: String.Format("{0} ({1})", base.GetDisplayText(value), col.AspectName);
		}
	}

	/// <summary>Control how the overlay is presented in the IDE</summary>
