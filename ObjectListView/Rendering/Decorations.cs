...
namespace BrightIdeasSoftware
{
	...
	public interface IDecoration : IOverlay
	{
		...
		/// <summary>Gets or sets the subitem that is to be decorated</summary>
		OLVListSubItem SubItem { get; set; }
	}

	/// <summary>An AbstractDecoration is a safe do-nothing implementation of the IDecoration interface</summary>
	public class AbstractDecoration : IDecoration
	{
		...
		/// <summary>Gets the bounds of the decorations row</summary>
		public Rectangle RowBounds => this.ListItem?.Bounds ?? Rectangle.Empty;

		/// <summary>Get the bounds of the decorations cell</summary>
		public Rectangle CellBounds
			=> this.ListItem == null || this.SubItem == null
				? Rectangle.Empty
				: this.ListItem.GetSubItemBounds(this.ListItem.SubItems.IndexOf(this.SubItem));

		#endregion

		#region IOverlay Members

		/// <summary>Draw the decoration</summary>
	...
	public class ColumnDecoration : AbstractDecoration
	{
		...
		/// <summary>Create a ColumnDecoration</summary>
		...
		public ColumnDecoration(OLVColumn column)
			: this()
			=> this.ColumnToDecorate = column ?? throw new ArgumentNullException(nameof(column));

		#endregion

		#region Properties

		/// <summary>Gets or sets the column that will be decorated</summary>
		public OLVColumn ColumnToDecorate { get; set; }

		/// <summary>Gets or sets the pen that will be used to draw the column decoration</summary>
		public Pen Pen
		{
			get => this._pen ?? Pens.DarkSlateBlue;
			set
			{
				if(this._pen == value)
					return;
		...
		/// <summary>Subclasses should override this to draw exactly what they want</summary>
		/// <param name="olv"></param>
		/// <param name="g"></param>
		/// <param name="r"></param>
	...
	public class TintedColumnDecoration : ColumnDecoration
	{
		...
		/// <summary>Create a TintedColumnDecoration</summary>
	...
	/// <summary>Specify on which side edge the decoration will be drawn</summary>
	...
	/// <summary>This decoration draws a line on the edge(s) of its given column</summary>
	/// <remarks>
	...
	public class ColumnEdgeDecoration : ColumnDecoration
	{
		...
		/// <summary>Create a ColumnEdgeDecoration</summary>
		public ColumnEdgeDecoration()
		{
		}

		/// <summary>Create a ColumnEdgeDecoration which draws a line over the right edges of the column (by default)</summary>
		/// <param name="column"></param>
		/// <param name="pen"></param>
		/// <param name="edge"></param>
		/// <param name="xOffset"></param>
		public ColumnEdgeDecoration(OLVColumn column, Pen pen = null, ColumnEdge edge = ColumnEdge.Right, Single xOffset = 0)
			: this()
		{
			this.ColumnToDecorate = column;
			this.Pen = pen;
		...
		/// <summary>Gets or sets whether this decoration will draw a line on the left or right edge of the column</summary>
		public ColumnEdge Edge { get; set; } = ColumnEdge.Right;

		/// <summary>Gets or sets the horizontal offset from centered at which the line will be drawn</summary>
		...
		public override void DrawDecoration(ObjectListView olv, Graphics g, Rectangle r, Rectangle columnBounds)
		{
			Single left = CalculateEdge(columnBounds);
			g.DrawLine(this.Pen, left, columnBounds.Top, left, columnBounds.Bottom);

		}

		private Single CalculateEdge(Rectangle columnBounds)
		{
			Single tweak = this.XOffset + (this.Pen.Width <= 2 ? 0 : 1);
			Int32 x = this.Edge == ColumnEdge.Left ? columnBounds.Left : columnBounds.Right;
	...
	public class BorderDecoration : AbstractDecoration
	{
		...
		/// <summary>Create a BorderDecoration</summary>
		...
		/// <summary>Gets or sets the pen that will be used to draw the border</summary>
		public Pen BorderPen { get; set; }

		/// <summary>Gets or sets the padding that will be added to the bounds of the item before drawing the border and fill.</summary>
		...
		/// <summary>Gets or sets the brush that will be used to fill the border</summary>
		...
		/// <summary>Gets or sets the color that will be used as the start of a gradient fill.</summary>
		/// <remarks>This and FillGradientTo must be given value to show a gradient</remarks>
		public Color? FillGradientFrom { get; set; }

		/// <summary>Gets or sets the color that will be used as the end of a gradient fill.</summary>
		/// <remarks>This and FillGradientFrom must be given value to show a gradient</remarks>
		public Color? FillGradientTo { get; set; }

		/// <summary>Gets or sets the fill mode that will be used for the gradient.</summary>
		...
		/// <summary>Draw a filled border</summary>
		/// <param name="olv"></param>
		/// <param name="g"></param>
		/// <param name="r"></param>
		public override void Draw(ObjectListView olv, Graphics g, Rectangle r)
		...
		/// <summary>Subclasses should override this to say where the border should be drawn</summary>
		/// <returns></returns>
		...
		/// <summary>Do the actual work of drawing the filled border</summary>
		/// <param name="g"></param>
		...
		/// <summary>Create a GraphicsPath that represents a round cornered rectangle.</summary>
	...
	/// <summary>Instances of this class draw a border around the decorated row</summary>
	public class RowBorderDecoration : BorderDecoration
	{
		/// <summary>Gets or sets the index of the left most column to be used for the border</summary>
		public Int32 LeftColumn { get; set; } = -1;

		/// <summary>Gets or sets the index of the right most column to be used for the border</summary>
		public Int32 RightColumn { get; set; } = -1;

		/// <summary>Calculate the boundaries of the border</summary>
		/// <returns></returns>
	...
	/// <summary>Instances of this class draw a border around the decorated subitem.</summary>
	...
	/// <summary>This decoration puts a border around the cell being edited and optionally "lightboxes" the cell (makes the rest of the control dark).</summary>
	public class EditingCellBorderDecoration : BorderDecoration
	{
		...
		/// <summary>Gets or set whether the decoration should make the rest of the control dark when a cell is being edited</summary>
		/// <remarks>If this is true, FillBrush is used to overpaint the control.</remarks>
		public Boolean UseLightbox
		{
	...
	{
		/// <summary>Create a LightBoxDecoration</summary>
		...
		/// <summary>Draw a tint over everything in the ObjectListView except the row under the mouse.</summary>
		/// <param name="olv"></param>
		/// <param name="g"></param>
		/// <param name="r"></param>
		public override void Draw(ObjectListView olv, Graphics g, Rectangle r)
	...
	/// <summary>Instances of this class put an Image over the row/cell that it is decorating</summary>
	public class ImageDecoration : ImageAdornment, IDecoration
	{
		#region Constructors

		/// <summary>Create an image decoration</summary>
		...
		public ImageDecoration(Image image, Int32 transparency)
			: this()
		{
			this.Image = image;
		...
		/// <param name="transparency"></param>
		/// <param name="alignment"></param>
		public ImageDecoration(Image image, Int32 transparency, ContentAlignment alignment)
			: this()
		{
			this.Image = image;
			this.Transparency = transparency;
		...
		/// <summary>Gets or sets the item being decorated</summary>
		public OLVListItem ListItem { get; set; }

		/// <summary>Gets or sets the sub item being decorated</summary>
		public OLVListSubItem SubItem { get; set; }
		...
		/// <summary>Draw this decoration</summary>
	...
	/// <summary>Instances of this class draw some text over the row/cell that they are decorating</summary>
	public class TextDecoration : TextAdornment, IDecoration
	{
		#region Constructors

		/// <summary>Create a TextDecoration</summary>
		...
		/// <param name="text"></param>
		/// <param name="transparency"></param>
		public TextDecoration(String text, Int32 transparency)
			: this(text)
			=> this.Transparency = transparency;
		...
		/// <param name="transparency"></param>
		/// <param name="alignment"></param>
		public TextDecoration(String text, Int32 transparency, ContentAlignment alignment)
