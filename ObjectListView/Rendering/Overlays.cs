...
{
	/// <summary>The interface for an Object which can draw itself over the top of an ObjectListView.</summary>
	public interface IOverlay
	{
		/// <summary>Draw this overlay</summary>
	...
	/// <summary>An interface for an overlay that supports variable levels of transparency</summary>
	...
	/// <summary>A null implementation of the IOverlay interface</summary>
	...
	{
		/// <summary>Create an ImageOverlay</summary>
		public ImageOverlay()
	...
	/// <summary>An overlay that will draw text over the top of the ObjectListView</summary>
	[TypeConverter("BrightIdeasSoftware.Design.OverlayConverter")]
	public class TextOverlay : TextAdornment, ITransparentOverlay
	{
		/// <summary>Create a TextOverlay</summary>
		public TextOverlay()
			=> this.Alignment = ContentAlignment.BottomRight;
		...
		/// <summary>Gets or sets whether the border will be drawn with rounded corners</summary>
		[Browsable(false)]
		[Obsolete("Use CornerRounding instead", false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public Boolean RoundCorneredBorder
		{
			get => this.CornerRounding > 0;
			set => this.CornerRounding = value ? 16.0f : 0.0f;
		}
	...
	/// <summary>A Billboard overlay is a TextOverlay positioned at an absolute point</summary>
	public class BillboardOverlay : TextOverlay
	{
		/// <summary>Create a BillboardOverlay</summary>
		...
		/// <summary>Gets or sets where should the top left of the billboard be placed</summary>
