...
namespace BrightIdeasSoftware
{
	...
	/// <summary>Instances of this class put a CheckedListBox into a tool strip menu item.</summary>
	public class ToolStripCheckedListBox : ToolStripControlHost
	{

		/// <summary>Create a ToolStripCheckedListBox</summary>
		...
		/// <summary>Gets the control embedded in the menu</summary>
		public CheckedListBox CheckedListBoxControl => this.Control as CheckedListBox;

		/// <summary>Gets the items shown in the checkedlistbox</summary>
		public CheckedListBox.ObjectCollection Items => this.CheckedListBoxControl.Items;

		/// <summary>Gets or sets whether an item should be checked when it is clicked</summary>
		public Boolean CheckedOnClick
		{
			get => this.CheckedListBoxControl.CheckOnClick;
			set => this.CheckedListBoxControl.CheckOnClick = value;
		}

		/// <summary>Gets a collection of the checked items</summary>
		public CheckedListBox.CheckedItemCollection CheckedItems => this.CheckedListBoxControl.CheckedItems;

		/// <summary>Add a possibly checked item to the control</summary>
		/// <param name="item"></param>
		/// <param name="isChecked"></param>
		public void AddItem(Object item, Boolean isChecked)
		{
			this.Items.Add(item);
			if(isChecked)
		...
		/// <summary>Add an item with the given state to the control</summary>
		/// <param name="item"></param>
		...
		/// <summary>Gets the checkedness of the i'th item</summary>
		/// <param name="i"></param>
		/// <returns></returns>
		public CheckState GetItemCheckState(Int32 i)
		{
			return this.CheckedListBoxControl.GetItemCheckState(i);
		}

		/// <summary>Set the checkedness of the i'th item</summary>
		/// <param name="i"></param>
		/// <param name="checkState"></param>
		public void SetItemState(Int32 i, CheckState checkState)
		{
			if(i >= 0 && i < this.Items.Count)
				this.CheckedListBoxControl.SetItemCheckState(i, checkState);
		}

		/// <summary>Check all the items in the control</summary>
		...
		/// <summary>Unchecked all the items in the control</summary>
		...
		/// <summary>Trigger the ItemCheck event</summary>
