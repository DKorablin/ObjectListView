...
namespace BrightIdeasSoftware
{
	...
	/// <summary>This defines whether a walk proceeds in a clockwise or anticlockwise direction.</summary>
	...
	/// <summary>A IPointLocator calculates a point relative to a given sprite.</summary>
	...
	/// <summary>A useful base class for point locators</summary>
	public class AbstractPointLocator : IPointLocator
	{
		...
		/// <summary>Gets the point from the locator</summary>
		/// <returns></returns>
		...
		/// <summary>The sprite associate with this locator has changed.</summary>
		/// <remarks>Make sure any dependent locators are updated</remarks>
		protected virtual void InitializeSublocators()
		{
		}

		/// <summary>Offset a point by our Offset property</summary>
		...
		/// <summary>Initialize the given locator so it refers to our sprite, unless it already refers to another one</summary>
	...
	/// <summary>A FixedPointLocator simply returns the point with which it is initialized.</summary>
	public class FixedPointLocator : AbstractPointLocator
	{
		...
		public override Point GetPoint()
			=> this.OffsetBy(this.Point);
	}

	/// <summary>A PointOnRectangleLocator calculate a point relative to rectangle.</summary>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <para>The reference rectangle defaults to the bounds of the animation</para>
	/// </remarks>
	public class PointOnRectangleLocator : AbstractPointLocator
	{
		...
		public PointOnRectangleLocator(IRectangleLocator locator, Single horizontal, Single vertical)
			: this(locator, horizontal, vertical, Point.Empty)
		{
		}

		public PointOnRectangleLocator(IRectangleLocator locator, Single horizontal, Single vertical, Point offset)
		{
			this.RectangleLocator = locator;
		...
		protected Point CalculateProportionalPosition(Rectangle r, SizeF proportions)
			=> new Point(
				r.X + (Int32)(r.Width * proportions.Width),
				r.Y + (Int32)(r.Height * proportions.Height));
	...
	/// <summary>An DifferenceLocator is simply the difference between two point locators</summary>
	[Obsolete("I can't think of a case where this would actually be useful. It might disappear. JPP 2010/02/05", false)]
	...
	/// <summary>A BaseWalker provides useful methods to classes that walk between a series of point.</summary>
	public class BaseWalker : AbstractPointLocator
	{
		public Single WalkProgress;
		...
		protected Point Walk(Int32 distance, Point pt, Point[] targetPoints)
		{
			Int32 i = 0;
			...
			while(true)
			{
				...
				if(remaining <= distanceToPoint)
					return this.CalculateEndPoint(pt, targetPoints[i], (Int32)remaining);
		...
		/// <summary>Given a start and end points, calculate the point that is distance along that line.</summary>
		...
		protected Point CalculateEndPoint(Point pt1, Point pt2, Int32 distance)
		{
			Int32 dx = pt2.X - pt1.X;
			Int32 dy = pt2.Y - pt1.Y;
			...
			return new Point(
				pt1.X + (Int32)(dx * inverseMagnitude * distance),
				pt1.Y + (Int32)(dy * inverseMagnitude * distance));
		}

		/// <summary>Calculate the distance between the two points</summary>
		/// <param name="pt1"></param>
		/// <param name="pt2"></param>
		/// <returns></returns>
		protected Double CalculateDistance(Point pt1, Point pt2)
		{
			Int32 dx = pt1.X - pt2.X;
			Int32 dy = pt1.Y - pt2.Y;
	...
	public class PointWalker : BaseWalker
	{
		...
		public override Point GetPoint()
		{
			...
			Int32 totalDistance = this.CalculateTotalDistance(points);
			return this.OffsetBy(this.Walk((Int32)(totalDistance * this.WalkProgress), points[0], points));
		}
		...
		private Int32 CalculateTotalDistance(Point[] points)
		{
			Double distance = 0;
			for(Int32 i = 1; i < points.Length; i++)
				distance += this.CalculateDistance(points[i - 1], points[i]);
			return (Int32)Math.Ceiling(distance + 1);
		}

		#endregion
	}

	/// <summary>Instances of this locator return points on the perimeter of a rectangle.</summary>
	public class RectangleWalker : BaseWalker
	{
		...
		{
			Rectangle r = this.RectangleLocator.GetRectangle();
			Int32 totalLength = r.Width * 2 + r.Height * 2;
			Int32 distanceToWalk = (Int32)(totalLength * this.WalkProgress);

			Point pt = this.RationalizeStartPoint(r, this.StartPointLocator.GetPoint());
			Int32 segment = this.DecideSegment(r, pt);
		...
		protected Int32 DecideSegment(Rectangle rectangleToWalk, Point point)
		{
