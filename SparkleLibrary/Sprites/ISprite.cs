...
namespace BrightIdeasSoftware
{
	public interface ISprite : IAnimateable
	{
		...
		/// <summary>
		/// Gets or sets the reference rectangle in relation to which the sprite will be drawn.
		/// This is normal the ClientArea of the control that is hosting the story board, though it
		/// could be a subarea of that control (e.g. a particular cell within a ListView).
		/// </summary>
		...
		/// This effect will run at the beginning of the sprite and will have 0 duration.
		/// </summary>
		...
		/// <summary>
		/// Add an Effect to this sprite.
		/// This effect will commences startTick's after the sprite begins and will have 0 duration
		/// </summary>
		/// <param name="startTick">When will the effect begins?</param>
		/// <param name="effect">What effect will be applied?</param>
		void Add(Int64 startTick, IEffect effect);
		...
		/// <param name="effect">What effect will be applied?</param>
		void Add(Int64 startTick, Int64 duration, IEffect effect);
	}
}